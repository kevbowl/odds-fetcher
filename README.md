...
```mermaid
flowchart LR
    cron["cron-job.org<br/>Every 15 min"] --> actions["GitHub Actions<br/>workflow_dispatch"]
    actions --> odds["The Odds API<br/>odds + events"]
    odds --> repo["GitHub<br/>odds/*.json commits"]
    repo --> analysis["Prophet<br/>Git history analysis"]
```
